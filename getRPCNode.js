const AidpcoinRPC = require("@aidpproject/aidpcoin-rpc");

const getConfig = require("./getConfig");
const config = getConfig();
const allNodes = [];

//At startup initialize all RPCs, you can have one or multiple Aidpcoin nodes
for (const node of config.nodes) {
  const rpc = AidpcoinRPC.getRPC(node.username, node.password, node.aidp_url);
